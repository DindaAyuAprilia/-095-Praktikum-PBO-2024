        ...
        while (true) {
            ...
            switch (pilihanUbah) {
                case "1":
                    ...
                    donaturDiubah.namaDonatur = input.readLine();
                    break;
                case "2":
                    System.out.print("Masukkan Umur Baru: ");
                    donaturDiubah.umurDonatur = Integer.parseInt(input.readLine());
                    break;
                case "3":
    ...
    for (int i = 0; i < daftarDonatur.size(); i++) {
        if (daftarDonatur.get(i).idDonatur == idDonatur) {
            ...
            switch (pilihanUbah) {
                case "1":
                    System.out.print("Masukkan Nama Baru: ");
                    daftarDonatur.get(i).namaDonatur = input.readLine();
                    break;
                case "2":
                    System.out.print("Masukkan Umur Baru: ");
                    daftarDonatur.get(i).umurDonatur = Integer.parseInt(input.readLine());
                    break;
                case "3":
                    System.out.print("Masukkan Pekerjaan Baru: ");
